...
Pipeline: จับเฟรม → RT-DETR หาป้าย → ตัด/ปรับภาพ → PaddleOCR (เฉพาะพยัญชนะไทย 44 ตัว + เลข 1–9999) → จับคู่จังหวัด 77 แห่ง → โหวตหลายเฟรม

OCR ไม่คืนตัวอังกฤษหรือสัญลักษณ์ — ถ้าอ่านไม่ออกจะรายงานว่าอ่านไม่ได้ ไม่เดาทะเบียน
